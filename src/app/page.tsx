...
function TeamRow({ name, odds }: { name: string; odds?: number }) { return <div className="flex items-center justify-between gap-3"><TeamName team={name} size="sm" className="text-sm font-black text-slate-900" /><span className="rounded-md bg-slate-100 px-2.5 py-1 text-xs font-black text-slate-700">{odds?.toFixed(2) ?? "-"}</span></div>; }
