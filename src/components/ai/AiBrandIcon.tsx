...
// OpenAI Blossom, sourced unchanged from Simple Icons v14.15.0.
const openAiIcon: BrandIcon = {
  title: "OpenAI",
...
const icons: Record<string, BrandIcon | undefined> = {
  gpt: openAiIcon,
  gemini: siGooglegemini,
  claude: siAnthropic,
  deepseek: siDeepseek,
  // xAI's official download is not bundled by Simple Icons; use the fallback.
  grok: undefined,
};
...
export function AiBrandIcon({
  ...
  return (
    <span
      className={clsx(
        "inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full border border-white/30 font-black text-white shadow-sm",
        sizeClasses[size],
        className,
      )}
